					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<%=request.getContextPath()%>/${user.profileImage}" alt="${user.name } Photo" />
					...
					<div class="page-content">
						...
						<div class="page-content-area" style="margin-left: 30px;">
							...
							<form class="form-inline">	
								<input type="text" class="form-control"  placeholder="검색어를 입력하세요" style="margin-left: 30px;"/> 
							...
							<div class="main-content form-inline">
								...
								<div class="w3-card-12" style="width:20%; float: left; margin-left: 10px;" >
								  <img src="/api/dummy/dummy1.jpg" class="img-rounded" style="width:100%">
								  <div class="w3-container w3-center">
								    <p style="font-style: oblique;">title1 </p>
								    <p>content</p>
								  </div>
								</div>
								<div class="w3-card-12" style="width:20%; float: left; margin-left: 10px;">
