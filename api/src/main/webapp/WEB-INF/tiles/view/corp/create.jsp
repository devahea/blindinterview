				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box">
						<div class="form-bottom">
							 <form role="form" action="${pageContext.request.contextPath}/corp/create" method="post" class="login-form"> 
								<div class="form-group">
									 <input
										type="text" name="id" placeholder="email을 입력하세요"
								...
								<div class="form-group">
									 <input
										type="password" name="teamName" placeholder="Name을 입력하세요"
										class="form-password form-control" id="teamName">
								</div>
								<div class="form-group">
									 <input
										type="password" name="teamSerialNo" placeholder="기업코드를 입력해주세요"
										class="form-password form-control" id="teamSerialNo">
								</div>
